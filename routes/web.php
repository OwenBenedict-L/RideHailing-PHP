...
Route::middleware('auth:driver')->group(function () {
    ...
    Route::patch('/chat/driver/{userId}/edit/{chatId}', [ChatController::class, 'updateChatDriver'])->name('chat.update.driver');
    Route::delete('/chat/driver/{userId}/delete/{chatId}', [ChatController::class, 'deleteChatDriver'])->name('chat.delete.driver');
