...
<head>
    ...
    <title>Driver Notification History</title>
    @vite(['resources/css/drivernotification-index.css']) 
</head>
<body>
    ...
    <div>
        ...
        @if(!$notifications->isEmpty())
            ...
            <form action="{{ route('driver-notifications.deleteAll') }}" method="POST" onsubmit="return confirm('Are you sure you want to delete ALL notifications?')">
                @csrf
                @method('DELETE')
                    ...
                    <tr style="{{ $notification->is_read ? 'background-color: #ffffff;' : 'background-color: #f4f7fc;' }}">
                        ...
                        <td>
                            <div style="display: flex; gap: 5px; align-items: center;">
                                ...
                                <form action="{{ route('driver-notifications.destroy', $notification->id) }}" method="POST" style="margin: 0;" onsubmit="return confirm('Are you sure you want to delete this notification?')">
                                    @csrf
                                    @method('DELETE')
